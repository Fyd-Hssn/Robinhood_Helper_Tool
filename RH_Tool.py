...
frame_list = [
    main_frame, option_frame, ticker_option_frame, underlying_frame,
    call_ratios_frame, put_ratios_frame, port_earnings_frame,
    list_earnings_frame
]
...
options_button = Button(main_frame,
...
ticker_long_call_button = Button(
    ticker_option_frame,
    text="Long Calls",
    command=lambda: ticker_option_returns(ticker_long_call_result,
                                          ticker_result, "long_call"),
    bg="SeaGreen3",
    width=20,
)
...
ticker_short_put_button = Button(
    ticker_option_frame,
    text="Short Puts",
    command=lambda: ticker_option_returns(ticker_short_put_result,
                                          ticker_result, "short_put"),
    bg="SeaGreen3",
    width=20,
)
...
ticker_long_put_button = Button(
    ticker_option_frame,
    text="Long Puts",
    command=lambda: ticker_option_returns(ticker_long_put_result,
                                          ticker_result, "long_put"),
    bg="SeaGreen3",
    width=20,
)
...
ticker_short_call_spread_button = Button(
    ...
    command=lambda: ticker_option_returns(ticker_short_call_spread_result,
                                          ticker_result, "short_call_spread"),
    bg="SeaGreen3",
    width=20,
)
...
ticker_short_put_spread_button = Button(
    ...
    command=lambda: ticker_option_returns(ticker_short_put_spread_result,
                                          ticker_result, "short_put_spread"),
    bg="SeaGreen3",
    width=20,
)
...
underlying_ticker_option_return_button = Button(
    ...
    command=lambda: ticker_option_returns(underlying_ticker_options_result,
...
underlying_combined_return_button = Button(
    ...
    command=lambda: print_combined_ticker_return(
        underlying_combined_return_result, underlying_ticker_entry,
...
underlying_buffer_label = Label(underlying_frame,
...
underlying_buffer_label2 = Label(underlying_frame,
...
underlying_ticker_label = Label(underlying_frame,
...
underlying_ticker_strat = Label(underlying_frame,
...
underlying_buffer_label3 = Label(underlying_frame, bg='LightSteelBlue4')
...
strat_list = [
    'All Strategies', 'Short Call', 'Long Call', 'Short Put', 'Long Put',
    'Short Call Spread', 'Short Put Spread', 'Iron Condor'
]

underlying_strat_menu = ttk.Combobox(underlying_frame,
                                     values=strat_list,
                                     width=109)
underlying_strat_menu.current(0)

underlying_equity_button.grid(row=0, column=0)
underlying_buffer_label.grid(row=1, columnspan=2)
...
underlying_buffer_label3.grid(row=4)
underlying_buffer_label2.grid(row=5, columnspan=2)
...
call_watchlist_menu = ttk.Combobox(call_ratios_frame,
                                   values=main().get_watchlists(),
                                   width=17)
...
call_date_submit = Button(
    call_ratios_frame,
    text="SUBMIT",
    command=lambda: print_ratios(call_watchlist_menu, call_expiration_input,
                                 call_ratios_screen),
    bg="DodgerBLue3",
    fg="white",
    width=21,
...
call_ratios_screen.insert(
    "1.0", "This will take a while depending on how big your list is!")
...
put_watchlist_menu = ttk.Combobox(put_ratios_frame,
                                  values=main().get_watchlists(),
                                  width=17)
...
put_date_submit = Button(
    put_ratios_frame,
    text="SUBMIT",
    command=lambda: print_ratios(put_watchlist_menu, put_expiration_input,
                                 put_ratios_screen),
    bg="DodgerBLue3",
    fg="white",
    width=21,
...
# List Earnings Page
list_watchlist_label = Label(list_earnings_frame,
                             text='Choose A Watchlist',
                             bg='LightSteelBlue4',
                             fg='white',
                             width=23)

list_watchlist_menu = ttk.Combobox(list_earnings_frame,
                                   values=main().get_watchlists(),
                                   width=25)
